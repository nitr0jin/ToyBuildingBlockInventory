### This project was created for a school assesment and the lines below describe the changes made to the provided code. This program creates a simple application that manages and displays the inventory for a toy building brick company. 
